        ...
        <div className="max-w-6xl mx-auto">
          ...
          {loading && (
            <div className="grid gap-6 md:grid-cols-2">
              {[1, 2, 3, 4].map((n) => (
                <div key={n} className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm animate-pulse">
          ...
          <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-2">
            {requests.map((req) => (
              <div 
                key={req._id} 
                className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm hover:shadow-lg transition-all duration-300 group flex flex-col"
              >
                <div className="flex justify-between items-start mb-4">
                  ...
                  <span className={`px-4 py-1.5 rounded-full text-xs font-bold tracking-wide flex items-center gap-1.5 ${
                ...
                <div className="bg-slate-50 rounded-xl p-4 space-y-3 mb-6 flex-grow border border-slate-100">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-500 uppercase tracking-wider">{req.vehicleNumber}</p>
                    </div>
                  </div>
                ...
                {req.status === "pending" && (
                  <div className="flex gap-3 mt-auto">
                    <button
                      ...
                      className={`flex-1 flex items-center justify-center gap-2 font-semibold px-4 py-2.5 rounded-xl transition-all duration-200 ${
