...
export const Hero = () => {
  ...
  return (
    <main className="relative w-full min-h-[85dvh] flex items-center justify-center px-4 sm:px-6 md:px-8 pt-24 pb-16 lg:pt-36 lg:pb-24 overflow-hidden bg-white">
      ...
      <div className="w-full max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center relative z-10">
        ...
        <motion.h1
  variants={itemVariants}
  className="text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight text-ink leading-[1.05]"
>
  The <span className="text-emerald-700">Smarter Way</span><br />
  to Manage <span className="text-emerald-700">Healthcare</span>.
</motion.h1>
<motion.p
  variants={itemVariants}
  className="text-ink-muted text-base sm:text-lg max-w-[650px] leading-relaxed font-medium"
>
  ...
  platform.
          ...
          >
            {/* Search Input */}
            <div className="flex-1 flex items-center w-full px-3 py-2 border-b md:border-b-0 md:border-r border-border">
            ...
            <div className="flex-1 relative w-full px-3 py-2 border-b md:border-b-0 md:border-r border-border flex items-center">
              <MapPin className={`w-4 h-4 text-primary mr-2.5 shrink-0 ${loadingLoc ? "animate-pulse" : ""}`} />
            ...
            {/* Search CTA */}
            <Button onClick={handleSearch} className="w-full md:w-auto px-6 h-[44px] shadow-sm hover:shadow-md transition-shadow">
              Search Now
            </Button>
          </motion.div>
          ...
          <motion.div
            variants={itemVariants}
            className="flex flex-wrap items-center gap-6 text-sm text-ink-muted font-semibold pt-2"
          >
            <div className="flex items-center gap-2 group cursor-default">
              <CheckCircle2 className="w-4 h-4 text-primary transition-transform group-hover:scale-110" />
