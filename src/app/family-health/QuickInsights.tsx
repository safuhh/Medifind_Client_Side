    ...
    <>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <motion.div
          ...
          transition={{ delay: 0 }}
          className="bg-gradient-to-br from-[#0a4d33] to-emerald-600 text-white p-5 rounded-2xl shadow-sm hover:shadow-md transition-shadow cursor-pointer"
        ...
        <motion.div
          ...
          className="bg-white border border-slate-100 p-5 rounded-2xl shadow-sm hover:shadow-md transition-shadow cursor-pointer"
          onClick={() => window.location.href = '/profile'}
        >
          <div className="flex items-center gap-3 mb-4">
          ...
          {upcomingBookings.length === 0 ? (
            ...
            <div className="space-y-3">
              {upcomingBookings.slice(0, 3).map((b: any, i: number) => (
                <div key={i} className="flex items-start gap-3 p-3 bg-blue-50/50 rounded-xl hover:bg-blue-100/50 transition-colors">
            ...
            <div className="space-y-3">
              {recentReports.slice(0, 3).map((r: any, i: number) => (
                <div 
                  ...
                  className="flex items-start gap-3 p-3 bg-emerald-50/50 rounded-xl cursor-pointer hover:bg-emerald-100/50 transition-colors"
                >
          ...
          {recentOrders.length === 0 ? (
            ...
            <div className="space-y-3">
              {recentOrders.slice(0, 3).map((o: any, i: number) => (
                <div key={i} className="flex items-start gap-3 p-3 bg-purple-50/50 rounded-xl hover:bg-purple-100/50 transition-colors">
